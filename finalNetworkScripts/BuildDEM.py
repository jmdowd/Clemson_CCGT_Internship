...
# Script submits a task that builds the Elevation Model(DEM) in our previously created project
...
batch_id6 = client.createBatch(filePath, [task6])

# Send the batch to the server node for processing
client.resumeBatch(batch_id6)
print("Job started...")
print("Building Dense Cloud...")

# Get the current status dictionary of the batch
stat = client.batchStatus(batch_id6)
