...
# Create a Metashape Network Task object called 'task3'    
task3 = Metashape.NetworkTask()
...
# Set the processing quality to Ultra, which is the highest quality for Metashape
task3.params['downscale'] = int(Metashape.UltraQuality)
# Set filtering to not filter 
task3.params['filter_mode'] = int(Metashape.FilterMode.NoFiltering)
