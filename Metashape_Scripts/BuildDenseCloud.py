...
# Create a Metashape Network Task object called 'task4'            
task4 = Metashape.NetworkTask()  
...
task4.params['downscale'] = int(Metashape.UltraQuality) 
# Set filtering to not filter     
task4.params['filter'] = int(Metashape.FilterMode.NoFiltering)
