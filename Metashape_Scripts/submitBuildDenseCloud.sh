...
#Starts Metashape offscreen and runs the Python Script BuildDenseCloud.py and passes arguments.txt as an argument to the script
sh $metashape/metashape.sh -platform offscreen -r $ad/BuildDenseCloud.py $cwd/arguments.txt
